<template>
    ...
    <!-- Avec "OrbitControls" -->
    <!-- "alpha" pour rendre le background autour de l'objet transparant -->
    <Renderer ref="renderer" antialias alpha resize v-bind:orbit-ctrl="{autoRotate: true, enableDamping: true, dampingFactor: 0.05 }">

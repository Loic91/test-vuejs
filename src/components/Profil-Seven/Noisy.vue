<template>
    <Renderer ref="renderer" alpha antialias resize v-bind:orbit-ctrl="{ enableZoom: false, enableRotate: false, enableDamping: true, dampingFactor: 0.05 }">
        ...
        <!-- <Scene background="#ffffff"></Scene> -->
            ...
            <PointLight ref="light1" v-bind:intensity="0.85" v-bind:position="{ x: 50, y: 0, z: 50 }" />
            <!-- <PointLight ref="light1" color="#0E09DC" v-bind:intensity="0.85" v-bind:position="{ x: 0, y: 0, z: 50 }" /> -->
            <PointLight ref="light2" color="#1CD1E1" v-bind:intensity="0.85" v-bind:position="{ x: 0, y: 0, z: 50 }" />
            <PointLight ref="light3" color="#18C02C" v-bind:intensity="0.85" v-bind:position="{ x: 0, y: 0, z: 50 }" />
            <PointLight ref="light4" color="#ee3bcf" v-bind:intensity="0.85" v-bind:position="{ x: 0, y: 0, z: 50 }" />
            ...
            <div v-if="!isMobile()">
                <desktop>
                    <NoisySphere
                        ...
                        v-bind:noise-coef="0.4"
                        v-bind:disp-coef="5"
                        v-bind:position="{ x: 0, y: 0, z: 0 }"
                    >
                        <PhongMaterial v-bind:color="colorSphere" />
                    </NoisySphere>

                    <NoisySphere
                        v-bind:radius="8"
                        v-bind:time-coef="0.0003"
                        v-bind:noise-coef="0.04"
                        v-bind:disp-coef="5"
                        v-bind:position="{ x: 50, y: 0, z: 0 }"
                    >
                        <PhongMaterial v-bind:color="colorSphere" />
                    </NoisySphere>
                </desktop>
